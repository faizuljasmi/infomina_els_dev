...
<div class="modal fade" id="createHoliday" tabindex="-1" role="dialog" aria-labelledby="createHolidayTitle" aria-hidden="true">
...
<div class="row">
    <div class ="col-md-6">
        ...
        <button type="button" onclick="HolidayCreate();" class="btn btn-primary" data-toggle="modal" data-target="#createHoliday">
        Create New Holiday
        </button>
    </div>
            ...
            <div class="card-header bg-teal">
                ...
                <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            ...
                            <td style="width: 10%">
                            <a href="{{route('holiday_edit',$hol)}}"><button type="button" onclick="HolidayCreate();" class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt"></i></button></a>
                            <a href="{{route('holiday_delete',$hol)}}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete {{$hol->name}}?')"><i class="fa fa-trash-alt"></i></a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
