            ...
            <div class="card card-primary">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="holiday_name" id="holiday_name" value="{{$holiday->name}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control float-right" name="date_from" value="{{$holiday->date_from}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control float-right" name="date_to" value="{{$holiday->date_to}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control float-right" name="total_days" value="{{$holiday->total_days}}">
                  </div>
                </div>
